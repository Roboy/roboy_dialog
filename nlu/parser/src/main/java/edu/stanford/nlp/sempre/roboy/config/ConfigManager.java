...
public class ConfigManager {
    ...
    private static void initializeConfig() {
        LogInfoToggle.begin_track("Initializing Config");
        ...
        try
        {
            ...
            if (!propertiesFile.exists()) { // propertiesFile == null doesn't work!
                LogInfoToggle.error("Could not find "+yamlConfigFile+" file in project path! YAML configurations will be unavailable.");
                return;
            }
            ...
            LogInfoToggle.errors("Exception while reading YAML configurations from %s", yamlConfigFile);
            LogInfoToggle.errors(e.getMessage());
        }
    }
