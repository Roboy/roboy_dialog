...
/**
 * Action used if the dialogue manager wants RoboyModel to express a certain emotional expression,
...
public class EmotionAction implements Action
{
	 ...
	 * 
	 * @param state The emotional expression. Possible values: angry, neutral, speak
	 * @param duration How long RoboyModel should display the given emotional expression
	 */
