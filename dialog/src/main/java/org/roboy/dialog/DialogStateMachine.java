...
public class DialogStateMachine {
    ...
    public DialogStateMachine(InferenceEngine inference, Context context, RosMainNode rosMainNode, Neo4jMemoryInterface memory) {
        ...
        if (this.inference == null) {
            ...
            throw new IllegalArgumentException("The inference is null. RoboyModel is a vegetable! Pulling the plug!");
        }
        if (this.context == null){
            logger.fatal("A conversation without context is not interpretable! (null was passed)");
            throw new IllegalArgumentException("The context is null. RoboyModel cannot talk without context. Stopping all dialog activity!");
        }
    }
     ...
     * Let semblance of intelligence penetrate the mind of RoboyModel
