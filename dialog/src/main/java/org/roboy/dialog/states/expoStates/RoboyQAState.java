 ...
 *
 * This state will:
 * - offer the interlocutor to ask a question about RoboyModel
 * - retrive the semantic parser result
 * - try to infer an asked question
 * - retrive the relevant information from the RoboyModel node
 * - compose an answer
 ...
 *    - abilities,
 *    - newPerson.
 * 3) Used 'infoFile' parameter containing RoboyModel answer phrases.
