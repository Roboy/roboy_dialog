 ...
 * The state tries to interact with the InterlocutorModel to update the existing information about the person.
 * This information is sent to the RoboyModel Memory Module through Neo4jMemoryInterface to keep it up to date.
 *
    ...
    public Output react(Interpretation input) {
        ...
        if (selectedPredicate != null) {
            if (result != null && !result.equals("")) {
                ...
                LOGGER.info(" -> Updated InterlocutorModel: " + person.getName());
            } else {
