package org.roboy.dialog.states.expoStates;
...
/**
 * This state asks the interlocutor whether RoboyModel should demonstrate one of his abilities.
 * The abilities include: shake hand, recognize objects, show emotion, move body
 *
 * Every time this state is entered, RoboyModel picks one of the abilities (that haven't been demonstrated yet)
