...
public class WildTalkStateParty extends State {
     ...
     */
    public WildTalkStateParty(String stateIdentifier, StateParameters params) {
    ...
    public Output react(ArrayList<Interpretation> input) {
        ...
        String sentence = input.get(0).getSentence();
