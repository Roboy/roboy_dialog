 ...
 *
 * BotBoyIntroductionState interface:
 ...
 */
public class BotBoyIntroductionState extends State {
    ...
    public BotBoyIntroductionState(String stateIdentifier, StateParameters params) {
    ...
    public Output react(Interpretation input) {
        ...
        if(person.FAMILIAR) {
            return Output.say(getResponsePhrase(person.getName(), person.FAMILIAR) +
                    retrievedPersonalFact + " It is great to chat with you again!").setSegue(s);
        }
