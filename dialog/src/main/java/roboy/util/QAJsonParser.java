...
public class QAJsonParser {
    ...
    public boolean parse(String file) {
        ...
        try {
            if (url != null) {
                ...
                entrySet = ((JsonObject) jsonTree).entrySet();
    ...
    public RandomList<String> getIntents() {
        RandomList<String> keys = new RandomList<>();
        if (!entrySet.isEmpty())
        {
            entrySet.forEach(x->keys.add(x.getKey()));
        }
        else {
            LOGGER.error("QAFileParser: no intents exist");
        }
        return keys;
    }
    ...
    public RandomList<String> getQuestions(String relationship) {
        return questions.get(relationship);
    }
    ...
    public Map<String, RandomList<String>> getAnswers(String property) {
        Map<String, RandomList<String>> answers = new HashMap<>();
        answers.put("SUCCESS", successAnswers.get(property));
        answers.put("FAILURE", failureAnswers.get(property));
    ...
    public RandomList<String> getSuccessAnswers(String property) {
        return successAnswers.get(property);
    }
    ...
    public RandomList<String> getFailureAnswers(String property) {
        return failureAnswers.get(property);
    }
    ...
    public Map<String, RandomList<String>> getFollowUp(String property) {
        Map<String, RandomList<String>> followUp = new HashMap<>();
        followUp.put("Q", followUpQuestions.get(property));
        followUp.put("A", followUpAnswers.get(property));
    ...
    public RandomList<String> getFollowUpQuestions(String property) {
        return followUpQuestions.get(property);
    }
    ...
    public RandomList<String> getFollowUpAnswers(String property) {
        return followUpAnswers.get(property);
    }
